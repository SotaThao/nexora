          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <h2 className="text-3xl sm:text-4xl font-black text-navy leading-tight" data-i18n="b2b-section-title">Team Up with Neighbors.<br />Everyone Wins.</h2>
              ...
              <div className="lg:col-span-6 grid grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-slate-50 border border-slate-200/80 p-3 sm:p-6 rounded-2xl sm:rounded-[24px] space-y-1.5 sm:space-y-3 hover:shadow-lg transition-all ds-surface ds-content-card">
                  <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-purple/10 text-purple flex items-center justify-center"><LucideIcon name="link-2" className="w-3.5 h-3.5 sm:w-5 sm:h-5" /></div>
                ...
                <div className="bg-slate-50 border border-slate-200/80 p-3 sm:p-6 rounded-2xl sm:rounded-[24px] space-y-1.5 sm:space-y-3 hover:shadow-lg transition-all ds-surface ds-content-card">
                  <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-purple/10 text-purple flex items-center justify-center"><LucideIcon name="bar-chart-2" className="w-3.5 h-3.5 sm:w-5 sm:h-5" /></div>
                ...
                <div className="bg-slate-50 border border-slate-200/80 p-3 sm:p-6 rounded-2xl sm:rounded-[24px] space-y-1.5 sm:space-y-3 hover:shadow-lg transition-all ds-surface ds-content-card">
                  <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-purple/10 text-purple flex items-center justify-center"><LucideIcon name="shield-check" className="w-3.5 h-3.5 sm:w-5 sm:h-5" /></div>
                ...
                <div className="bg-slate-50 border border-slate-200/80 p-3 sm:p-6 rounded-2xl sm:rounded-[24px] space-y-1.5 sm:space-y-3 hover:shadow-lg transition-all ds-surface ds-content-card">
                  <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-purple/10 text-purple flex items-center justify-center"><LucideIcon name="megaphone" className="w-3.5 h-3.5 sm:w-5 sm:h-5" /></div>
