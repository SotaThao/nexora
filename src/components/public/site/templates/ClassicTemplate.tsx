...
export const ClassicTemplate: React.FC<TemplateProps> = ({
  ...
  return (
    <div className="min-h-screen font-sans relative pb-16 sm:pb-0" style={{ backgroundColor: palette.bgPrimary }}>
      ...
      <VipAmenitiesSection palette={palette} isMobileView={isMobileView} />
