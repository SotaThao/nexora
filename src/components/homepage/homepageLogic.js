...
const translations = {
  vi: {
    ...
    "hero-desc": "Một mã QR thông minh. Khách hàng tip trực tiếp cho nhân viên — không phí thẻ. Họ tự động để lại đánh giá Google. Và họ nhận được ưu đãi để quay lại lần sau.",
    "hero-btn-primary": "Dùng Thử Demo Ngay",
    "hero-btn-secondary": "Ước Tính Số Tiền Tiết Kiệm",
    "hero-badge-title": "BẠN NHẬN ĐƯỢC GÌ",
    "badge-1": "Tip Miễn Phí",
    "badge-2": "Tự Động Đánh Giá Google",
    "badge-3": "Một Mã QR Cho Tất Cả",
    ...
    "faq-eyebrow": "FAQ",
    "faq-title": "FAQ Nexora Touch",
    "faq-intro": "Smart QR cho tip, review, loyalty và dashboard cho chủ tiệm/staff.",
    "faq-subtitle": "",
    "faq-tag-overview": "Tổng quan",
    "faq-tag-why": "Vì sao Nexora",
    "faq-tag-direct-tip": "Tip trực tiếp",
    "faq-tag-customer": "Trải nghiệm khách",
    "faq-tag-qr": "Smart QR",
    "faq-tag-dashboard": "Dashboard",
    "faq-tag-reviews": "Review",
    "faq-tag-setup": "Thiết lập",
    "faq-q-1": "Nexora Touch là gì?",
    "faq-a-1": "Nexora Touch là app Smart QR giúp tiệm nhận tip trực tiếp, thu review, quản lý staff, theo dõi QR và xây dựng loyalty trong một hệ thống.",
    "faq-q-2": "Nexora Touch khác gì so với app tip hoặc QR thông thường?",
    "faq-a-2": "Nhiều công cụ chỉ làm một việc như tạo QR, nhận tip hoặc xin review. Nexora Touch gom toàn bộ hành trình từ quét QR, chọn staff, tip, review, tích điểm đến dashboard quản lý.",
    "faq-q-3": "Tại sao tiệm nên dùng Nexora Touch thay vì chỉ để khách tip bằng ví cá nhân?",
    "faq-a-3": "Khách vẫn tip tiện lợi qua phương thức quen thuộc, nhưng tiệm có thêm dữ liệu giao dịch, đúng staff, lịch sử tip, review và báo cáo hiệu suất.",
    "faq-q-4": "Khách hàng có cần tải app không?",
    "faq-a-4": "Không. Khách chỉ cần quét QR và thao tác trên trình duyệt, giúp quá trình tip, thanh toán và review nhanh hơn nhiều so với việc bắt khách tải app.",
    "faq-q-5": "Smart QR tiện hơn QR thường ở điểm nào?",
    "faq-a-5": "QR thường chỉ mở một link cố định. Smart QR của Nexora có thể gắn với từng trạm, bàn, quầy hoặc staff, đồng thời chủ tiệm có thể theo dõi lượt quét, trạng thái và hiệu suất.",
    "faq-q-6": "Tip trực tiếp hoạt động như thế nào?",
    "faq-a-6": "Khách quét QR, chọn staff, chọn số tiền tip và gửi trực tiếp theo phương thức được staff hoặc tiệm cấu hình. App giúp ghi nhận và điều phối luồng tip rõ ràng hơn.",
    "faq-q-7": "Chủ tiệm và staff mỗi bên dùng app để làm gì?",
    "faq-a-7": "Chủ tiệm quản lý staff, QR, review, tip, thanh toán và báo cáo. Staff có dashboard riêng để xem tip, review, QR cá nhân, payment methods và các tiệm đang liên kết.",
    "faq-q-8": "Nexora Touch giúp tăng review Google/Yelp như thế nào?",
    "faq-a-8": "Sau khi khách hoàn tất tip hoặc trải nghiệm, app mời khách đánh giá. Khách hài lòng có thể được dẫn ra Google/Yelp, còn phản hồi chưa tốt được gửi nội bộ để tiệm xử lý.",
    "faq-q-9": "Nexora Touch có chỉ dùng cho tip không?",
    "faq-a-9": "Không. App còn hỗ trợ QR thanh toán cho business, review routing, loyalty điểm thưởng, staff portal và dashboard vận hành cho chủ tiệm.",
    "faq-q-10": "Sau khi đăng ký, tiệm bắt đầu dùng Nexora Touch như thế nào?",
    "faq-a-10": "Tiệm thiết lập hồ sơ, thêm staff, cấu hình phương thức nhận tiền, tạo QR cho các trạm cần dùng và bắt đầu chia sẻ QR cho khách.",
    "cta-title": "Sẵn Sàng Ngừng Trả Phí Xử Lý Tip?",
    "cta-desc": "Hàng loạt tiệm đã tiết kiệm hàng nghìn đô mỗi năm cùng Nexora Touch.",
    "btn-cta-1": "Bắt Đầu Miễn Phí",
    "btn-cta-2": "Đặt Lịch Demo",
  ...
  en: {
    ...
    "hero-desc": "One smart QR code. Your customers tip your staff directly — no card fees. They leave Google reviews automatically. And they earn rewards to come back.",
    "hero-btn-primary": "Try the Live Demo",
    "hero-btn-secondary": "Calculate Net Savings",
    "hero-badge-title": "WHAT YOU GET",
    "badge-1": "Zero-Fee Tips",
    "badge-2": "Auto Google Reviews",
    "badge-3": "One QR for Everything",
    ...
    "faq-eyebrow": "FAQ",
    "faq-title": "Nexora Touch FAQ",
    "faq-intro": "Smart QR for tips, reviews, loyalty, and owner/staff dashboards.",
    "faq-subtitle": "",
    "faq-tag-overview": "App Overview",
    "faq-tag-why": "Why Nexora",
    "faq-tag-direct-tip": "Direct Tips",
    "faq-tag-customer": "Customer Flow",
    "faq-tag-qr": "Smart QR",
    "faq-tag-dashboard": "Dashboards",
    "faq-tag-reviews": "Reviews",
    "faq-tag-setup": "Setup",
    "faq-q-1": "What is Nexora Touch?",
    "faq-a-1": "Nexora Touch is a Smart QR app that helps businesses manage direct tips, reviews, staff, QR stations, and loyalty in one system.",
    "faq-q-2": "How is Nexora Touch different from regular tipping or QR apps?",
    "faq-a-2": "Many tools only handle QR, tipping, or reviews. Nexora Touch connects the full journey from scan, staff selection, tipping, reviews, rewards, and business dashboards.",
    "faq-q-3": "Why should a business use Nexora Touch instead of only personal wallet tips?",
    "faq-a-3": "Customers still tip through familiar methods, but the business gains transaction records, correct staff routing, tip history, reviews, and performance reports.",
    "faq-q-4": "Do customers need to download an app?",
    "faq-a-4": "No. Customers scan a QR code and use the browser, making tipping, payment, and reviews much faster than forcing an app download.",
    "faq-q-5": "How is Smart QR better than a regular QR code?",
    "faq-a-5": "A regular QR opens a static link. Nexora Smart QR can connect to stations, tables, front desk, or staff, while owners track scans, status, and performance.",
    "faq-q-6": "How does direct tipping work?",
    "faq-a-6": "Customers scan, select staff, choose a tip amount, and send it directly through the configured method. The app records and organizes the tipping flow.",
    "faq-q-7": "What do owners and staff use the app for?",
    "faq-a-7": "Owners manage staff, QR, reviews, tips, payments, and reports. Staff get their own dashboard for tips, reviews, personal QR, payment methods, and linked businesses.",
    "faq-q-8": "How does Nexora Touch help increase Google/Yelp reviews?",
    "faq-a-8": "After tipping or service, the app prompts customers to rate the experience. Happy customers can be routed to Google/Yelp, while lower feedback is captured privately.",
    "faq-q-9": "Does Nexora Touch only handle tips?",
    "faq-a-9": "No. The app also supports business payment QR, review routing, loyalty rewards, staff portals, and owner dashboards.",
    "faq-q-10": "How does a business start using Nexora Touch after signing up?",
    "faq-a-10": "The business sets up its profile, adds staff, configures receiving methods, creates QR stations, and starts sharing QR codes with customers.",
    "cta-title": "Ready to Stop Paying Tip Processing Fees?",
    "cta-desc": "Join salons already saving thousands per year with Nexora Touch.",
    "btn-cta-1": "Get Started Free",
    "btn-cta-2": "Schedule a Demo",
