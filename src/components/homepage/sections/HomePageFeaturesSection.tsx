          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group ds-surface ds-content-card">
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple to-indigo-600 flex items-center justify-center text-white mb-3 sm:mb-6 shadow-md shadow-purple/20 group-hover:scale-110 transition-transform">
                  <LucideIcon name="banknote" className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group ds-surface ds-content-card">
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple to-indigo-600 flex items-center justify-center text-white mb-3 sm:mb-6 shadow-md shadow-purple/20 group-hover:scale-110 transition-transform">
                  <LucideIcon name="star" className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group ds-surface ds-content-card">
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple to-indigo-600 flex items-center justify-center text-white mb-3 sm:mb-6 shadow-md shadow-purple/20 group-hover:scale-110 transition-transform">
                  <LucideIcon name="gift" className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group ds-surface ds-content-card">
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple to-indigo-600 flex items-center justify-center text-white mb-3 sm:mb-6 shadow-md shadow-purple/20 group-hover:scale-110 transition-transform">
                  <LucideIcon name="qr-code" className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group ds-surface ds-content-card">
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple to-indigo-600 flex items-center justify-center text-white mb-3 sm:mb-6 shadow-md shadow-purple/20 group-hover:scale-110 transition-transform">
                  <LucideIcon name="circle-user" className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>
              ...
              <div className="bg-slate-50 border border-slate-200/60 rounded-2xl p-4 sm:p-8 hover:shadow-xl hover:scale-[1.01] transition-all duration-300 group ds-surface ds-content-card">
                <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-purple to-indigo-600 flex items-center justify-center text-white mb-3 sm:mb-6 shadow-md shadow-purple/20 group-hover:scale-110 transition-transform">
                  <LucideIcon name="layout-dashboard" className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>
