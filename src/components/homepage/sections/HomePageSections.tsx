...
import HomePageRewardsSection from './HomePageRewardsSection'
...
import HomePageDownloadAppSection from './HomePageDownloadAppSection'
...
import HomePageAuthModal from './HomePageAuthModal'
import HomePageReceiptScannerModal from './HomePageReceiptScannerModal'
...
export default function HomePageSections() {
  return (
    <>
      ...
      <HomePageRewardsSection />
      <HomePageCalculatorSection />
      <HomePageFeaturesSection />
      <HomePagePricingSection />
      <HomePageDownloadAppSection />
      <HomePageCtaSection />
      <HomePageFooterSection />
      <HomePageDemoModal />
      <HomePageAuthModal />
      <HomePageReceiptScannerModal />
    </>
  )
}
