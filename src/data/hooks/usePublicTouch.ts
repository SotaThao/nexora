...
export function useCreateTip() {
  return useMutation<unknown, Error, { touchPointId: any; staffProfileId: any; amount: any; paymentMethod: any; sessionId: any }>({
    /**
     * @param {object} args
...
export function useSkipTip() {
  return useMutation<unknown, Error, { touchPointId: any; staffProfileId: any; sessionId: any }>({
    /**
     * @param {object} args
     * @param {string} args.touchPointId
     * @param {string} args.staffProfileId
...
export function useCreateReview() {
  return useMutation<unknown, Error, { touchPointId: any; tipId?: any; staffProfileId: any; rating: any; comment: any; customerEmail: any; customerName: any }>({
    /**
     * @param {object} args
     * @param {string}  args.touchPointId
     ...
     */
    mutationFn: (args) => publicTouchRepository.createReview(args as any),
  })
}
...
export function useCreateMultiStaffTip() {
  return useMutation<unknown, Error, { businessId: any; touchPointId: any; businessPaymentMethodId: any; tipItems: any }>({
    /**
     * @param {object} args
