    ...
    <div className={containerClass}>
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          <div className="flex min-w-0 items-center gap-2">
            <div className="truncate text-sm font-extrabold text-nexoraText">{businessName}</div>
      ...
      <div className="flex shrink-0 items-center gap-2">
        <button
          ...
          disabled={isPending}
          className="inline-flex min-h-9 items-center gap-1.5 rounded-lg bg-nexoraBrand px-3 text-xs font-extrabold text-white transition hover:bg-nexoraBrandDark disabled:cursor-not-allowed disabled:opacity-60"
        >
        ...
        <button
          ...
          disabled={isPending}
          className="inline-flex min-h-9 items-center gap-1.5 rounded-lg border border-nexoraDanger/20 bg-nexoraDanger/10 px-3 text-xs font-extrabold text-nexoraDanger transition hover:bg-nexoraDanger/15 disabled:cursor-not-allowed disabled:opacity-60"
        >
