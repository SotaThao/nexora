...
function SkillBar({ title, percentage }: SkillBarProps) {
  return (
    <div>
...
function ToolCard({ icon, name, desc, color }: ToolCardProps) {
  return (
...
const ResumeCard: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#EFE5FC] via-[#FDFCF8] to-[#E2F5ED] font-sans relative">
      
      {/* Top Header */}
      <div className="absolute top-8 left-8 flex items-center gap-3">
        <div className="w-10 h-10 bg-[#1A162B] rounded-xl flex items-center justify-center text-white font-black text-xl shadow-lg">
          S
        </div>
        <div>
        ...
        <div className="max-w-5xl w-full flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-[35%] bg-white rounded-[32px] p-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center text-center">
            ...
            <div className="relative mb-6">
              <div className="absolute inset-0 bg-gradient-to-br from-[#9D72FF] to-[#4D45F5] rounded-full blur-[14px] opacity-40" />
